const path2array = (pathName = '', source = {}) => {
    const tmpPath = {
        "rest_id": () => source?.id_str ?? source?.data?.user?.result?.rest_id ?? source?.core?.user_results?.result?.rest_id ?? source?.rest_id ?? false,
        "user_is_blue_verified": () => source?.data?.user?.result?.is_blue_verified ?? source?.ext_is_blue_verified ?? source?.is_blue_verified ?? false,
        "user_info_legacy": () => source?.data?.user?.result?.legacy ?? source?.legacy ?? source ?? false,
        "tweets_instructions": () => source?.globalObjects?.tweets ?? source?.data?.user?.result?.timeline_v2?.timeline?.instructions ?? source?.data?.user?.result?.timeline?.timeline?.instructions ?? source?.data?.threaded_conversation_with_injections_v2?.instructions ?? source?.data?.threaded_conversation_with_injections?.instructions ?? source?.data?.search_by_raw_query?.search_timeline?.timeline?.instructions ?? source?.data?.home?.home_timeline_urt?.instructions ?? source?.data?.bookmark_timeline_v2?.timeline?.instructions ?? source?.data?.list?.tweets_timeline?.timeline?.instructions ?? source?.data?.list?.members_timeline?.timeline?.instructions ?? source?.data?.communityResults?.result?.community_timeline?.timeline?.instructions ?? false,
        "tweets_contents": () => source?.globalObjects?.tweets ?? source?.data?.user?.result?.timeline_v2?.timeline?.instructions[1]?.entries ?? source?.data?.user?.result?.timeline_v2?.timeline?.instructions[0]?.entries ?? source?.data?.user?.result?.timeline?.timeline?.instructions[1]?.entries ?? source?.data?.user?.result?.timeline?.timeline?.instructions[0]?.entries ?? source?.data?.threaded_conversation_with_injections_v2?.instructions[1]?.entries ?? source?.data?.threaded_conversation_with_injections_v2?.instructions[0]?.entries ?? source?.data?.threaded_conversation_with_injections?.instructions[1]?.entries ?? source?.data?.threaded_conversation_with_injections?.instructions[0]?.entries ?? source?.data?.search_by_raw_query?.search_timeline?.timeline?.instructions[1]?.entries ?? source?.data?.search_by_raw_query?.search_timeline?.timeline?.instructions[0]?.entries ?? source?.data?.home?.home_timeline_urt?.instructions[0]?.entries ?? source?.data?.bookmark_timeline_v2?.timeline?.instructions[0]?.entries ?? source?.data?.list?.tweets_timeline?.timeline?.instructions[1]?.entries ?? source?.data?.list?.tweets_timeline?.timeline?.instructions[0]?.entries ?? source?.data?.communityResults?.result?.community_timeline?.timeline?.instructions[1]?.entries ?? source?.data?.communityResults?.result?.community_timeline?.timeline?.instructions[0]?.entries ?? false,
